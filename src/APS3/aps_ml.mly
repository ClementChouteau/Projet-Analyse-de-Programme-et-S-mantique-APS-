...
%%
	...
	|	PAREN_G VECT_TYPE typeaps PAREN_D		{ Ast.TypeVector $3 }
	;
	typesaps:
	...
	|	FUN IDENT typeaps CROCHET_G args CROCHET_D prog	{ Ast.DecFonctionRet ($2, $3, $5, $7) }
	|	FUN REC IDENT typeaps CROCHET_G args CROCHET_D prog { Ast.DecFonctionRecRet ($3, $4,$6, $8) }
	...
	|	SET lval expr { Ast.SetLval ($2, $3) }
	;
	lval:
		IDENT	{ Ast.IdLval $1 }
	|	PAREN_G OPRIM lval expr PAREN_D	{ if $2 = "nth" then Ast.VectorLval ($3, $4) else raise Parsing.Parse_error }
	expr:
		BOOL	{ Ast.Bool $1 }
	|	NUM		{ Ast.Int $1 }
